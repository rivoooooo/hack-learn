...
> **功能分类**：Web 应用 ｜ **Kali 包**：`sidguesser` ｜ **官方文档**：<https://www.kali.org/tools/sidguesser/>
...
| 版本 | 1.0.5 |
| 架构 | any |
| 可执行命令 | `sidguesser`、`sidguess` |
| 依赖 | `libc6`、`sidguess` |
| 安装体积 | 25 KB |
| 官网 | <http://www.cqure.net/wp/tools/database/sidguesser/> |
| 源码仓库 | <https://gitlab.com/kalilinux/packages/sidguesser> |
| 包追踪 | <https://pkg.kali.org/pkg/sidguesser> |
...
- [ ] **1.** **装好并确认版本** —— `sudo apt install sidguesser`，再执行 `sidguesser --version` 2>/dev/null || `sidguesser -V`
- [ ] **2.** **读官方帮助** —— `sidguesser -h`，需要细节时 `man sidguesser`
- [ ] **3.** **在自有靶场跑最小用例** —— 用 `sidguesser -h` 里最简单的那个子命令试一次
- [ ] **4.** **对照官方文档确认参数语义** —— <https://www.kali.org/tools/sidguesser/>，重点核对上一步用到的每个参数
...
- Kali 官方工具页：<https://www.kali.org/tools/sidguesser/>

---

## 来源

- 工具元数据与用法示例、help 原文均抓取自 <https://www.kali.org/tools/sidguesser/>（同步日期：2026-09-15）
