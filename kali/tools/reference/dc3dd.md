...
> Patched version of GNU dd with forensic features dc3dd is a patched version of GNU dd with added features for computer forensics: on the fly hashing (md5, sha-1, sha-256, and sha-512); possibility to write errors to a file; group errors in…

> **功能分类**：数字取证 ｜ **Kali 包**：`dc3dd` ｜ **官方文档**：<https://www.kali.org/tools/dc3dd/>
...
| 源码仓库 | <https://salsa.debian.org/pkg-security-team/dc3dd> |
| 包追踪 | <https://pkg.kali.org/pkg/dc3dd> |
...
dc3dd completed at 2026-09-14 05:28:24 -0400
Learn more with
OffSec
Want to learn more about dc3dd? get access to in-depth training and hands-on labs:
Intro to dc3dd
...
- [ ] **1.** **装好并确认版本** —— `sudo apt install dc3dd`，再执行 `dc3dd --version` 2>/dev/null || `dc3dd -V`
- [ ] **2.** **读官方帮助** —— `dc3dd -h`，需要细节时 `man dc3dd`
- [ ] **3.** **在自有靶场跑最小用例** —— 用 `dc3dd -h` 里最简单的那个子命令试一次
- [ ] **4.** **对照官方文档确认参数语义** —— <https://www.kali.org/tools/dc3dd/>，重点核对上一步用到的每个参数
...
- Kali 官方工具页：<https://www.kali.org/tools/dc3dd/>

---

## 来源

- 工具元数据与用法示例、help 原文均抓取自 <https://www.kali.org/tools/dc3dd/>（同步日期：2026-09-15）
