...
> **功能分类**：通用工具 ｜ **Kali 包**：`hostsman` ｜ **官方文档**：<https://www.kali.org/tools/hostsman/>
...
| 架构 | all |
| 可执行命令 | `hostsman` |
| 依赖 | `python3`、`python3-colorama`、`python3-mock`、`python3-pygments` |
| 安装体积 | 51 KB |
| 官网 | <https://github.com/qszhuan/hostsman> |
| 源码仓库 | <https://gitlab.com/kalilinux/packages/hostsman> |
| 包追踪 | <https://pkg.kali.org/pkg/hostsman> |
...
- [ ] **1.** **装好并确认版本** —— `sudo apt install hostsman`，再执行 `hostsman --version` 2>/dev/null || `hostsman -V`
- [ ] **2.** **读官方帮助** —— `hostsman -h`，需要细节时 `man hostsman`
- [ ] **3.** **在自有靶场跑最小用例** —— 用 `hostsman -h` 里最简单的那个子命令试一次
- [ ] **4.** **对照官方文档确认参数语义** —— <https://www.kali.org/tools/hostsman/>，重点核对上一步用到的每个参数
...
- Kali 官方工具页：<https://www.kali.org/tools/hostsman/>

---

## 来源

- 工具元数据与用法示例、help 原文均抓取自 <https://www.kali.org/tools/hostsman/>（同步日期：2026-09-15）
