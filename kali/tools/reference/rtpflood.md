...
> **功能分类**：漏洞分析 ｜ **Kali 包**：`rtpflood` ｜ **官方文档**：<https://www.kali.org/tools/rtpflood/>
...
| 源码仓库 | <https://gitlab.com/kalilinux/packages/rtpflood> |
| 包追踪 | <https://pkg.kali.org/pkg/rtpflood> |
...
- [ ] **1.** **装好并确认版本** —— `sudo apt install rtpflood`，再执行 `rtpflood --version` 2>/dev/null || `rtpflood -V`
- [ ] **2.** **读官方帮助** —— `rtpflood -h`，需要细节时 `man rtpflood`
- [ ] **3.** **在自有靶场跑最小用例** —— 用 `rtpflood -h` 里最简单的那个子命令试一次
- [ ] **4.** **对照官方文档确认参数语义** —— <https://www.kali.org/tools/rtpflood/>，重点核对上一步用到的每个参数
...
- Kali 官方工具页：<https://www.kali.org/tools/rtpflood/>

---

## 来源

- 工具元数据与用法示例、help 原文均抓取自 <https://www.kali.org/tools/rtpflood/>（同步日期：2026-09-15）
