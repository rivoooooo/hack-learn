...
> **功能分类**：Web 应用 ｜ **Kali 包**：`webacoo` ｜ **官方文档**：<https://www.kali.org/tools/webacoo/>
...
| 架构 | all |
| 可执行命令 | `webacoo` |
| 依赖 | `libio-socket-socks-perl`、`liburi-perl`、`perl` |
| 安装体积 | 65 KB |
| 官网 | <https://github.com/anestisb/WeBaCoo> |
| 源码仓库 | <https://gitlab.com/kalilinux/packages/webacoo> |
| 包追踪 | <https://pkg.kali.org/pkg/webacoo> |
...
- [ ] **1.** **装好并确认版本** —— `sudo apt install webacoo`，再执行 `webacoo --version` 2>/dev/null || `webacoo -V`
- [ ] **2.** **读官方帮助** —— `webacoo -h`，需要细节时 `man webacoo`
- [ ] **3.** **在自有靶场跑最小用例** —— 官方给出的调用形式是：`Usage: webacoo [options]`
- [ ] **4.** **对照官方文档确认参数语义** —— <https://www.kali.org/tools/webacoo/>，重点核对上一步用到的每个参数
...
- Kali 官方工具页：<https://www.kali.org/tools/webacoo/>

---

## 来源

- 工具元数据与用法示例、help 原文均抓取自 <https://www.kali.org/tools/webacoo/>（同步日期：2026-09-15）
