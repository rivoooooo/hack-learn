...
> **功能分类**：通用工具 ｜ **Kali 包**：`ciphey` ｜ **官方文档**：<https://www.kali.org/tools/ciphey/>

## 1. 安装

```bash
sudo apt update
sudo apt install ciphey
```
...
| 版本 | 5.14.0 |
| 架构 | all |
| 可执行命令 | `python3-ciphey`、`ciphey` |
| 官网 | <https://github.com/Ciphey/Ciphey> |
| 源码仓库 | <https://gitlab.com/kalilinux/packages/ciphey> |
| 包追踪 | <https://pkg.kali.org/pkg/ciphey> |
...
```bash
python3-ciphey -h          # 查看用法
man python3-ciphey         # 查看手册
```
...
- [ ] **1.** **装好并确认版本** —— `sudo apt install ciphey`，再执行 `python3-ciphey --version` 2>/dev/null || `python3-ciphey -V`
- [ ] **2.** **读官方帮助** —— `python3-ciphey -h`，需要细节时 `man python3-ciphey`
- [ ] **3.** **在自有靶场跑最小用例** —— 官方给出的调用形式是：`Usage: ciphey [OPTIONS] [TEXT_STDIN]`
- [ ] **4.** **对照官方文档确认参数语义** —— <https://www.kali.org/tools/ciphey/>，重点核对上一步用到的每个参数
...
- Kali 官方工具页：<https://www.kali.org/tools/ciphey/>

---

## 来源

- 工具元数据与用法示例、help 原文均抓取自 <https://www.kali.org/tools/ciphey/>（同步日期：2026-09-15）
